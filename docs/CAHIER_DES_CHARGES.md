...
| Périmètre à réduire pour absorber ce Must tardif    | L'enveloppe impose : « ce changement est un Must qui arrive tard, donc quelque chose doit sortir du périmètre »                                                  | Le temps disponible après l'enveloppe a finalement permis de traiter la double relecture **et** les deux stories Should restantes (EF9, EF10), sans rien sacrifier au final — mais la décision a été prise dans cet ordre : d'abord la double relecture proprement, EF9/EF10 seulement une fois celle-ci terminée et vérifiée | La priorisation reste la même que si le temps avait manqué : Must avant Should, jamais l'inverse. Rien n'a été bâclé pour caser les deux ensembles |
